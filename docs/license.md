...
engine, MemSmith Server, CLI, SDKs, adapters, MCP tools, schemas, tests,
...
MemSmith is intended to be embedded broadly inside developer tools, local
...
MemSmith Server v0.1 does not ship hosted cloud, team sync, enterprise
