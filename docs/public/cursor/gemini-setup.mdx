...
description: "Use MemSmith in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up MemSmith in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
{
  "MEMSMITH_PROVIDER": "gemini",
  "MEMSMITH_GEMINI_API_KEY": "your-key",
  "MEMSMITH_GEMINI_MODEL": "gemini-2.5-flash"
}
```
