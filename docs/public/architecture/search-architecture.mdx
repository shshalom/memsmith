...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/shshalom/plugin/scripts/mcp-server.cjs`
...
The 3-layer workflow embodies **progressive disclosure** - a core principle of memsmith's architecture.
...
2. Check database: `ls ~/.memsmith/memsmith.db`
