...
description: "Learn how MemSmith works automatically in the background"
---

# Getting Started with MemSmith

## Automatic Operation

MemSmith works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, memsmith captures it:
...
Context is stored in SQLite database at `~/.memsmith/memsmith.db`.
...
MemSmith supports sessions that span multiple user prompts:
...
MemSmith provides MCP tools for querying your project history. Simply ask naturally:
