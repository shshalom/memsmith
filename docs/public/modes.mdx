...
description: "Configure MemSmith behavior and language with the Mode System"
---

# Modes & Languages

MemSmith uses a flexible **Mode System** to adapt its behavior, observation types, and output language. This allows you to switch between different workflows (like coding vs. email investigation) or languages without reinstalling the plugin.
...
Set the active mode using the `MEMSMITH_MODE` setting in `~/.memsmith/settings.json`:
