...
<p align="center">
  MemSmith säilyttää kontekstin saumattomasti istuntojen välillä tallentamalla automaattisesti työkalujen käyttöhavaintoja, luomalla semanttisia yhteenvetoja ja asettamalla ne tulevien istuntojen saataville. Tämä mahdollistaa Clauden säilyttää tiedon jatkuvuuden projekteista senkin jälkeen, kun istunnot päättyvät tai yhteys palautuu.
</p>
...
📚 **[Näytä täydellinen dokumentaatio](https://docs.memsmith.ai/)** - Selaa virallisella verkkosivustolla

### Aloitus

- **[Asennusopas](https://docs.memsmith.ai/installation)** - Pikaopas ja edistynyt asennus
- **[Käyttöopas](https://docs.memsmith.ai/usage/getting-started)** - Miten MemSmith toimii automaattisesti
- **[Hakutyökalut](https://docs.memsmith.ai/usage/search-tools)** - Kysy projektihistoriaasi luonnollisella kielellä
- **[Beta-ominaisuudet](https://docs.memsmith.ai/beta-features)** - Kokeile kokeellisia ominaisuuksia kuten Endless Mode

### Parhaat käytännöt

- **[Kontekstisuunnittelu](https://docs.memsmith.ai/context-engineering)** - AI-agentin kontekstin optimointiperiaatteet
- **[Asteittainen paljastaminen](https://docs.memsmith.ai/progressive-disclosure)** - Filosofia MemSmith-kontekstin valmistelustrategian takana

### Arkkitehtuuri

- **[Yleiskatsaus](https://docs.memsmith.ai/architecture/overview)** - Järjestelmän komponentit ja datavirta
- **[Arkkitehtuurin kehitys](https://docs.memsmith.ai/architecture-evolution)** - Matka versiosta v3 versioon v5
- **[Koukku-arkkitehtuuri](https://docs.memsmith.ai/hooks-architecture)** - Miten MemSmith käyttää elinkaarikkoukkuja
- **[Koukku-viittaus](https://docs.memsmith.ai/architecture/hooks)** - 7 koukku-skriptiä selitettynä
- **[Worker-palvelu](https://docs.memsmith.ai/architecture/worker-service)** - HTTP API ja Bun-hallinta
- **[Tietokanta](https://docs.memsmith.ai/architecture/database)** - SQLite-skeema ja FTS5-haku
- **[Hakuarkkitehtuuri](https://docs.memsmith.ai/architecture/search-architecture)** - Hybridihaku Chroma-vektoritietokannalla

### Asetukset ja kehitys

- **[Asetukset](https://docs.memsmith.ai/configuration)** - Ympäristömuuttujat ja asetukset
- **[Kehitys](https://docs.memsmith.ai/development)** - Rakentaminen, testaus, osallistuminen
- **[Vianmääritys](https://docs.memsmith.ai/troubleshooting)** - Yleiset ongelmat ja ratkaisut
...
Katso [Arkkitehtuurin yleiskatsaus](https://docs.memsmith.ai/architecture/overview) yksityiskohdista.

---

## mem-search-taito

MemSmith tarjoaa älykkään haun mem-search-taidon kautta, joka käynnistyy automaattisesti kun kysyt aiemmasta työstä:
...
Katso [Hakutyökalujen opas](https://docs.memsmith.ai/usage/search-tools) yksityiskohtaisia esimerkkejä varten.

---

## Beta-ominaisuudet

MemSmith tarjoaa **beta-kanavan** kokeellisilla ominaisuuksilla kuten **Endless Mode** (biomimeettinen muistiarkkitehtuuri pidennetyille istunnoille). Vaihda vakaan ja beta-version välillä web-katselukäyttöliittymästä osoitteessa http://localhost:37777 → Settings.

Katso **[Beta-ominaisuuksien dokumentaatio](https://docs.memsmith.ai/beta-features)** yksityiskohdista Endless Moden ja sen kokeilemisen osalta.
...
Asetuksia hallitaan tiedostossa `~/.memsmith/settings.json` (luodaan automaattisesti oletusarvoilla ensimmäisellä suorituskerralla). Määritä AI-malli, worker-portti, datahakemisto, lokitaso ja kontekstin injektointiasetukset.

Katso **[Asetusopas](https://docs.memsmith.ai/configuration)** kaikista saatavilla olevista asetuksista ja esimerkeistä.

---

## Kehitys

Katso **[Kehitysopas](https://docs.memsmith.ai/development)** rakennusohjeista, testauksesta ja osallistumisen työnkulusta.
...
Katso **[Vianmääritysopas](https://docs.memsmith.ai/troubleshooting)** yleisistä ongelmista ja ratkaisuista.
...
Katso [Kehitysopas](https://docs.memsmith.ai/development) osallistumisen työnkulusta.
...
- **Ongelmat**: [GitHub Issues](https://github.com/shshalom/memsmith/issues)
- **Repositorio**: [github.com/shshalom/memsmith](https://github.com/shshalom/memsmith)
- **Tekijä**: Alex Newman ([@shshalom](https://github.com/shshalom))
