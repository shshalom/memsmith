...
📚 **[Se Fuld Dokumentation](https://docs.memsmith.ai/)** - Gennemse på den officielle hjemmeside

### Kom Godt I Gang

- **[Installationsguide](https://docs.memsmith.ai/installation)** - Hurtig start & avanceret installation
- **[Brugervejledning](https://docs.memsmith.ai/usage/getting-started)** - Sådan fungerer MemSmith automatisk
- **[Søgeværktøjer](https://docs.memsmith.ai/usage/search-tools)** - Forespørg din projekthistorik med naturligt sprog
- **[Beta-funktioner](https://docs.memsmith.ai/beta-features)** - Prøv eksperimentelle funktioner som Endless Mode

### Bedste Praksis

- **[Kontekst-engineering](https://docs.memsmith.ai/context-engineering)** - AI-agent kontekstoptimeringsprincipper
- **[Progressiv Afsløring](https://docs.memsmith.ai/progressive-disclosure)** - Filosofien bag MemSmiths kontekst-priming-strategi

### Arkitektur

- **[Oversigt](https://docs.memsmith.ai/architecture/overview)** - Systemkomponenter & dataflow
- **[Arkitekturudvikling](https://docs.memsmith.ai/architecture-evolution)** - Rejsen fra v3 til v5
- **[Hooks-arkitektur](https://docs.memsmith.ai/hooks-architecture)** - Hvordan MemSmith bruger livscyklus-hooks
- **[Hooks-reference](https://docs.memsmith.ai/architecture/hooks)** - 7 hook-scripts forklaret
- **[Worker Service](https://docs.memsmith.ai/architecture/worker-service)** - HTTP API & Bun-administration
- **[Database](https://docs.memsmith.ai/architecture/database)** - SQLite-skema & FTS5-søgning
- **[Søgearkitektur](https://docs.memsmith.ai/architecture/search-architecture)** - Hybrid søgning med Chroma vektordatabase

### Konfiguration & Udvikling

- **[Konfiguration](https://docs.memsmith.ai/configuration)** - Miljøvariabler & indstillinger
- **[Udvikling](https://docs.memsmith.ai/development)** - Bygning, testning, bidrag
- **[Fejlfinding](https://docs.memsmith.ai/troubleshooting)** - Almindelige problemer & løsninger
...
Se [Arkitekturoversigt](https://docs.memsmith.ai/architecture/overview) for detaljer.

---

## mem-search-færdighed

MemSmith leverer intelligent søgning gennem mem-search-færdigheden, der automatisk aktiveres, når du spørger om tidligere arbejde:
...
Se [Søgeværktøjsguide](https://docs.memsmith.ai/usage/search-tools) for detaljerede eksempler.

---

## Beta-funktioner

MemSmith tilbyder en **beta-kanal** med eksperimentelle funktioner som **Endless Mode** (biomimetisk hukommelsesarkitektur til udvidede sessioner). Skift mellem stabile og beta-versioner fra web viewer UI på http://localhost:37777 → Settings.

Se **[Beta-funktionsdokumentation](https://docs.memsmith.ai/beta-features)** for detaljer om Endless Mode og hvordan du prøver det.
...
Indstillinger administreres i `~/.memsmith/settings.json` (auto-oprettet med standardindstillinger ved første kørsel). Konfigurer AI-model, worker-port, datakatalog, log-niveau og indstillinger for kontekstindsprøjtning.

Se **[Konfigurationsguide](https://docs.memsmith.ai/configuration)** for alle tilgængelige indstillinger og eksempler.

---

## Udvikling

Se **[Udviklingsguide](https://docs.memsmith.ai/development)** for bygningsinstruktioner, testning og bidragsworkflow.
...
Se **[Fejlfindingsguide](https://docs.memsmith.ai/troubleshooting)** for almindelige problemer og løsninger.
...
Se [Udviklingsguide](https://docs.memsmith.ai/development) for bidragsworkflow.
