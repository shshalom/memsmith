...
📚 **[Vizualizați Documentația Completă](https://docs.memsmith.ai/)** - Răsfoiți pe site-ul oficial

### Introducere

- **[Ghid de Instalare](https://docs.memsmith.ai/installation)** - Start rapid și instalare avansată
- **[Ghid de Utilizare](https://docs.memsmith.ai/usage/getting-started)** - Cum funcționează MemSmith automat
- **[Instrumente de Căutare](https://docs.memsmith.ai/usage/search-tools)** - Interogați istoricul proiectului cu limbaj natural
- **[Funcții Beta](https://docs.memsmith.ai/beta-features)** - Încercați funcții experimentale precum Endless Mode

### Practici Recomandate

- **[Inginerie Context](https://docs.memsmith.ai/context-engineering)** - Principii de optimizare a contextului pentru agenți AI
- **[Dezvăluire Progresivă](https://docs.memsmith.ai/progressive-disclosure)** - Filosofia din spatele strategiei de pregătire a contextului MemSmith

### Arhitectură

- **[Prezentare Generală](https://docs.memsmith.ai/architecture/overview)** - Componente de sistem și flux de date
- **[Evoluția Arhitecturii](https://docs.memsmith.ai/architecture-evolution)** - Parcursul de la v3 la v5
- **[Arhitectura Hooks](https://docs.memsmith.ai/hooks-architecture)** - Cum folosește MemSmith hook-urile de ciclu de viață
- **[Referință Hooks](https://docs.memsmith.ai/architecture/hooks)** - 7 scripturi de hook explicate
- **[Serviciu Worker](https://docs.memsmith.ai/architecture/worker-service)** - HTTP API și gestionare Bun
- **[Baza de Date](https://docs.memsmith.ai/architecture/database)** - Schemă SQLite și căutare FTS5
- **[Arhitectura Căutării](https://docs.memsmith.ai/architecture/search-architecture)** - Căutare hibridă cu baza de date vectorială Chroma

### Configurare și Dezvoltare

- **[Configurare](https://docs.memsmith.ai/configuration)** - Variabile de mediu și setări
- **[Dezvoltare](https://docs.memsmith.ai/development)** - Construire, testare, contribuție
- **[Depanare](https://docs.memsmith.ai/troubleshooting)** - Probleme comune și soluții
...
Consultați [Prezentarea Generală a Arhitecturii](https://docs.memsmith.ai/architecture/overview) pentru detalii.

---

## Abilitatea mem-search

MemSmith oferă căutare inteligentă prin abilitatea mem-search care se invocă automat când întrebați despre lucrul trecut:
...
Consultați [Ghidul Instrumentelor de Căutare](https://docs.memsmith.ai/usage/search-tools) pentru exemple detaliate.

---

## Funcții Beta

MemSmith oferă un **canal beta** cu funcții experimentale precum **Endless Mode** (arhitectură de memorie biomimetică pentru sesiuni extinse). Comutați între versiunile stabile și beta din interfața web viewer la http://localhost:37777 → Settings.

Consultați **[Documentația Funcțiilor Beta](https://docs.memsmith.ai/beta-features)** pentru detalii despre Endless Mode și cum să îl încercați.
...
Setările sunt gestionate în `~/.memsmith/settings.json` (creat automat cu valori implicite la prima rulare). Configurați modelul AI, portul worker, directorul de date, nivelul de log și setările de injectare a contextului.

Consultați **[Ghidul de Configurare](https://docs.memsmith.ai/configuration)** pentru toate setările disponibile și exemple.

---

## Dezvoltare

Consultați **[Ghidul de Dezvoltare](https://docs.memsmith.ai/development)** pentru instrucțiuni de construire, testare și flux de contribuție.
...
Consultați **[Ghidul de Depanare](https://docs.memsmith.ai/troubleshooting)** pentru probleme comune și soluții.
...
Consultați [Ghidul de Dezvoltare](https://docs.memsmith.ai/development) pentru fluxul de contribuție.
...
- **Probleme**: [GitHub Issues](https://github.com/shshalom/memsmith/issues)
