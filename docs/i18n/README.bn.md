...
<p align="center">
  MemSmith স্বয়ংক্রিয়ভাবে টুল ব্যবহারের পর্যবেক্ষণ ক্যাপচার করে, সিমান্টিক সারসংক্ষেপ তৈরি করে এবং সেগুলি ভবিষ্যতের সেশনে উপলব্ধ করে সেশন জুড়ে প্রসঙ্গ নির্বিঘ্নে সংরক্ষণ করে। এটি Claude কে সেশন শেষ হওয়ার বা পুনঃসংযোগের পরেও প্রকল্প সম্পর্কে জ্ঞানের ধারাবাহিকতা বজায় রাখতে সক্ষম করে।
</p>
...
📚 **[সম্পূর্ণ ডকুমেন্টেশন দেখুন](https://docs.memsmith.ai/)** - অফিসিয়াল ওয়েবসাইটে ব্রাউজ করুন

### শুরু করা

- **[ইনস্টলেশন গাইড](https://docs.memsmith.ai/installation)** - দ্রুত শুরু এবং উন্নত ইনস্টলেশন
- **[ব্যবহার গাইড](https://docs.memsmith.ai/usage/getting-started)** - MemSmith কীভাবে স্বয়ংক্রিয়ভাবে কাজ করে
- **[অনুসন্ধান টুল](https://docs.memsmith.ai/usage/search-tools)** - প্রাকৃতিক ভাষা দিয়ে আপনার প্রকল্পের ইতিহাস অনুসন্ধান করুন
- **[বিটা বৈশিষ্ট্য](https://docs.memsmith.ai/beta-features)** - Endless Mode-এর মতো পরীক্ষামূলক বৈশিষ্ট্য চেষ্টা করুন

### সর্বোত্তম অনুশীলন

- **[প্রসঙ্গ ইঞ্জিনিয়ারিং](https://docs.memsmith.ai/context-engineering)** - AI এজেন্ট প্রসঙ্গ অপটিমাইজেশন নীতি
- **[প্রগতিশীল প্রকাশ](https://docs.memsmith.ai/progressive-disclosure)** - MemSmith-এর প্রসঙ্গ প্রাইমিং কৌশলের পিছনে দর্শন

### আর্কিটেকচার

- **[সারসংক্ষেপ](https://docs.memsmith.ai/architecture/overview)** - সিস্টেম উপাদান এবং ডেটা ফ্লো
- **[আর্কিটেকচার বিবর্তন](https://docs.memsmith.ai/architecture-evolution)** - v3 থেকে v5 পর্যন্ত যাত্রা
- **[হুকস আর্কিটেকচার](https://docs.memsmith.ai/hooks-architecture)** - MemSmith কীভাবে লাইফসাইকেল হুক ব্যবহার করে
- **[হুকস রেফারেন্স](https://docs.memsmith.ai/architecture/hooks)** - ৭টি হুক স্ক্রিপ্ট ব্যাখ্যা করা হয়েছে
- **[ওয়ার্কার সার্ভিস](https://docs.memsmith.ai/architecture/worker-service)** - HTTP API এবং Bun ম্যানেজমেন্ট
- **[ডাটাবেস](https://docs.memsmith.ai/architecture/database)** - SQLite স্কিমা এবং FTS5 অনুসন্ধান
- **[অনুসন্ধান আর্কিটেকচার](https://docs.memsmith.ai/architecture/search-architecture)** - Chroma ভেক্টর ডাটাবেস সহ হাইব্রিড অনুসন্ধান

### কনফিগারেশন এবং ডেভেলপমেন্ট

- **[কনফিগারেশন](https://docs.memsmith.ai/configuration)** - পরিবেশ ভেরিয়েবল এবং সেটিংস
- **[ডেভেলপমেন্ট](https://docs.memsmith.ai/development)** - বিল্ডিং, টেস্টিং, অবদান
- **[সমস্যা সমাধান](https://docs.memsmith.ai/troubleshooting)** - সাধারণ সমস্যা এবং সমাধান
...
বিস্তারিত জানতে [আর্কিটেকচার সারসংক্ষেপ](https://docs.memsmith.ai/architecture/overview) দেখুন।

---

## অনুসন্ধান টুল

MemSmith, mem-search skill-এর মাধ্যমে বুদ্ধিমান অনুসন্ধান প্রদান করে যা আপনি পূর্ববর্তী কাজ সম্পর্কে জিজ্ঞাসা করলে স্বয়ংক্রিয়ভাবে চালু হয়:
...
বিস্তারিত উদাহরণের জন্য [অনুসন্ধান টুল গাইড](https://docs.memsmith.ai/usage/search-tools) দেখুন।

---

## বিটা বৈশিষ্ট্য

MemSmith একটি **বিটা চ্যানেল** অফার করে যাতে **Endless Mode**-এর মতো পরীক্ষামূলক বৈশিষ্ট্য রয়েছে (বর্ধিত সেশনের জন্য বায়োমিমেটিক মেমরি আর্কিটেকচার)। http://localhost:37777 → Settings-এ ওয়েব ভিউয়ার UI থেকে স্থিতিশীল এবং বিটা সংস্করণের মধ্যে স্যুইচ করুন।

Endless Mode এবং এটি কীভাবে চেষ্টা করবেন সে সম্পর্কে বিস্তারিত জানতে **[বিটা বৈশিষ্ট্য ডকুমেন্টেশন](https://docs.memsmith.ai/beta-features)** দেখুন।
...
সেটিংস `~/.memsmith/settings.json`-এ পরিচালিত হয় (প্রথম রানে ডিফল্ট সহ স্বয়ংক্রিয়ভাবে তৈরি হয়)। AI মডেল, ওয়ার্কার পোর্ট, ডেটা ডিরেক্টরি, লগ লেভেল এবং প্রসঙ্গ ইনজেকশন সেটিংস কনফিগার করুন।

সমস্ত উপলব্ধ সেটিংস এবং উদাহরণের জন্য **[কনফিগারেশন গাইড](https://docs.memsmith.ai/configuration)** দেখুন।

---

## ডেভেলপমেন্ট

বিল্ড নির্দেশাবলী, টেস্টিং এবং অবদান ওয়ার্কফ্লোর জন্য **[ডেভেলপমেন্ট গাইড](https://docs.memsmith.ai/development)** দেখুন।
...
সাধারণ সমস্যা এবং সমাধানের জন্য **[সমস্যা সমাধান গাইড](https://docs.memsmith.ai/troubleshooting)** দেখুন।
...
অবদান ওয়ার্কফ্লোর জন্য [ডেভেলপমেন্ট গাইড](https://docs.memsmith.ai/development) দেখুন।
...
- **ইস্যু**: [GitHub Issues](https://github.com/shshalom/memsmith/issues)
- **রিপোজিটরি**: [github.com/shshalom/memsmith](https://github.com/shshalom/memsmith)
- **লেখক**: Alex Newman ([@shshalom](https://github.com/shshalom))
