...
function formatObservationsForClaudeMd(observations: ObservationRow[], folderPath: string): string {
  ...
  lines.push('');
  lines.push('<!-- This section is auto-generated by memsmith. Edit content outside the tags. -->');
  lines.push('');
...
export async function generateClaudeMd(dryRun: boolean): Promise<number> {
  ...
  const observationLimit = parseInt(settings.MEMSMITH_CONTEXT_OBSERVATIONS, 10) || 50;
