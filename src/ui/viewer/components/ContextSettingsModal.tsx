        ...
        <div className="modal-body">
          ...
          <div className="settings-column">
            ...
            >
              ...
              >
                <select
                  value={formState.MEMSMITH_PROVIDER || 'claude'}
                  onChange={(e) => updateSetting('MEMSMITH_PROVIDER', e.target.value)}
                >
              ...
              {formState.MEMSMITH_PROVIDER === 'claude' && (
                <FormField
                  label="Claude Model"
                  tooltip="Claude model used for generating observations"
                >
                  <select
                    value={formState.MEMSMITH_MODEL || 'haiku'}
                    onChange={(e) => updateSetting('MEMSMITH_MODEL', e.target.value)}
                  >
              ...
              {formState.MEMSMITH_PROVIDER === 'gemini' && (
                <>
                  <FormField
                  ...
                  >
                    <input
                      type="password"
                      value={formState.MEMSMITH_GEMINI_API_KEY || ''}
                      onChange={(e) => updateSetting('MEMSMITH_GEMINI_API_KEY', e.target.value)}
                  ...
                  >
                    <select
                      value={formState.MEMSMITH_GEMINI_MODEL || 'gemini-2.5-flash-lite'}
                      onChange={(e) => updateSetting('MEMSMITH_GEMINI_MODEL', e.target.value)}
                    >
                  ...
                  <div className="toggle-group" style={{ marginTop: '8px' }}>
                    <ToggleSwitch
                      ...
                      checked={formState.MEMSMITH_GEMINI_RATE_LIMITING_ENABLED === 'true'}
                      onChange={(checked) => updateSetting('MEMSMITH_GEMINI_RATE_LIMITING_ENABLED', checked ? 'true' : 'false')}
                    />
                  </div>
                </>
              )}

              {formState.MEMSMITH_PROVIDER === 'openrouter' && (
                <>
                  <FormField
                  ...
                  >
                    <input
                      type="password"
                      value={formState.MEMSMITH_OPENROUTER_API_KEY || ''}
                      onChange={(e) => updateSetting('MEMSMITH_OPENROUTER_API_KEY', e.target.value)}
                  ...
                  >
                    <input
                      type="text"
                      value={formState.MEMSMITH_OPENROUTER_MODEL || 'xiaomi/mimo-v2-flash:free'}
                      onChange={(e) => updateSetting('MEMSMITH_OPENROUTER_MODEL', e.target.value)}
                  ...
                  >
                    <input
                      type="text"
                      value={formState.MEMSMITH_OPENROUTER_SITE_URL || ''}
                      onChange={(e) => updateSetting('MEMSMITH_OPENROUTER_SITE_URL', e.target.value)}
                  ...
                  >
                    <input
                      type="text"
                      value={formState.MEMSMITH_OPENROUTER_APP_NAME || 'memsmith'}
                      onChange={(e) => updateSetting('MEMSMITH_OPENROUTER_APP_NAME', e.target.value)}
                      placeholder="memsmith"
                    />
                  </FormField>
                </>
              )}
              ...
              >
                <input
                  ...
                  min="1024"
                  max="65535"
                  value={formState.MEMSMITH_WORKER_PORT || '37777'}
                  onChange={(e) => updateSetting('MEMSMITH_WORKER_PORT', e.target.value)}
                />
              </FormField>
