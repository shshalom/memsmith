...
| `RAGTIME_PLUGIN_PATH` | `./plugin` | Path to memsmith plugin |
| `MEMSMITH_WORKER_PORT` | `37777` | Worker service port |
...
1. **Startup**: Sets `MEMSMITH_MODE=email-investigation` and cleans up old transcripts
...
The main memsmith repository is licensed under Apache-2.0, and ragtime now uses the same license for this migration.
