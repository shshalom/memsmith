...
### Custom Grammars (`.memsmith.json`)

You can register additional tree-sitter grammars for file types not in the bundled list. Create or update `.memsmith.json` in your project root:
